...
\lstinputlisting[language=C++]{sample_cpp.cpp}
...
\lstinputlisting[language=Python, linerange={70-77}]{rundirectory_function.py}
...
\lstinputlisting[language=Python, linerange={79-97}]{rundirectory_function.py}
